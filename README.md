...
| 프로젝트 | 기간 | 커밋 | Conventional | AI Co-Authored | 비고 |
|:---|---:|---:|---:|---:|:---|
| **Rooton** | 73일 | 269 | 96.7% | 76.2% | 실제 고객사 납품 운영 |
| **AXBrief** | **6일 4시간** | 94 | **98.9%** | **84%** | Turborepo 모노레포 Phase 1-A 완료 |
| Diffnote | 21일 | 102 | 70.6% | 44% | Stage 1~13 · Product Hunt 런칭 준비 · 7 PRs merged |
| MarkUI | 30일 | 126 | 73.8% | — ⁽¹⁾ | Codex CLI 기반 |
| Kidsroad | 32일 | 75 | 85.3% | 52% | AI 데이터 파이프라인 + Vercel Cron |
| Haru Ending | 23일 | 22 | 90.9% | 9% | fixture-first 하네스 엔지니어링 |
| StageCaption | 7일 | 10 | **100%** | — | 기획·아키텍처 저장소 |
| **합계** | ~6개월 | **698** | **~87%** | **~38%** | |

⁽¹⁾ MarkUI는 Codex CLI 기반으로 Claude Co-Authored 트레일러 없이 운영. `AGENTS.md` 운영 규칙은 동일하게 적용.
...
> 📅 73일 · 🧾 269 commits · ✨ Conventional 96.7% · 🤖 AI Co-Authored 76.2%
...
- Claude Code 에이전트(`backend-architect` · `frontend-developer` · `task-orchestrator`)와 Task Master 명령으로 작업 자동화 — AI Co-Authored 76.2%
...
> 📅 6일 4시간 · 🧾 94 commits · ✨ Conventional 98.9% · 🤖 AI Co-Authored 84%
...
- **Conventional Commits 98.9% × AI Co-Authored 84%** — 빠르면서도 도메인별 scope·검증 파이프라인 유지
...
> 📅 32일 · 🧾 75 commits · ✨ Conventional 85.3% · 🤖 AI Co-Authored 52%
...
> 📅 7일 · 🧾 10 commits · ✨ Conventional 100% (기획·아키텍처 저장소)
...
> 📅 23일 · 🧾 22 commits · ✨ Conventional 90.9%
...
> 📅 21일 · 🧾 102 commits · ✨ Conventional 70.6% · 🤖 AI Co-Authored 44% · 🔀 7 PRs all merged
...
> 📅 30일 · 🧾 126 commits · ✨ Conventional 73.8% · 🤖 Codex CLI 기반
...
| **Now** | AI 시대 풀스택 · FDE 지향 | 6개월 698 커밋 · 7개 프로덕트 · 평균 87% Conventional Commits |
